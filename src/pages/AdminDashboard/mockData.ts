...
export const MOCK_PENDING_REQUESTS: PendingRequest[] = [
  {
    ...
    borrowDate: '2025-01-15', returnDate: '2025-01-18',
    submittedAt: '2025-01-13 09:21',
  },
  {
    key: '2', id: 'REQ-0090',
    studentName: 'Trần Thị Bình',
    deviceName: 'Micro không dây Shure PG58',
    borrowDate: '2025-01-14', returnDate: '2025-01-16',
    submittedAt: '2025-01-13 08:55',
  },
  {
    key: '3', id: 'REQ-0089',
    studentName: 'Lê Minh Cường',
    deviceName: 'Loa Bluetooth JBL Xtreme 3',
    borrowDate: '2025-01-16', returnDate: '2025-01-17',
    submittedAt: '2025-01-12 22:10',
  },
  {
    key: '4', id: 'REQ-0088',
    studentName: 'Phạm Thị Dung',
    deviceName: 'Camera Sony ZV-E10',
    borrowDate: '2025-01-15', returnDate: '2025-01-20',
    submittedAt: '2025-01-12 18:45',
  },
  {
    key: '5', id: 'REQ-0087',
    studentName: 'Hoàng Văn Em',
    deviceName: 'Tripod chụp ảnh Manfrotto',
    borrowDate: '2025-01-13', returnDate: '2025-01-14',
